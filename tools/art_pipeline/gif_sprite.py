"""
Sprite-sheet split/compose helpers.

Vendored from FrameRonin-MCP tools/gif_sprite.py (see VENDOR.md).
The GIF extract/compose functions are not vendored — out of scope for this pipeline.
"""
